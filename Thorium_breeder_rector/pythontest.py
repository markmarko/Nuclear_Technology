...
fuel_material.add_nuclide("Th232", 92)
fuel_material.add_nuclide("U235", 7)
...
#mesh_xy.lower_left = [-100,-100,-1.e5]
#mesh_xy.upper_right = [100,100,1.e5]
...
#mesh_xz.lower_left = [-100,-1.e5,-100]
#mesh_xz.upper_right = [100,1.e5,100]
...
#mesh_yz.lower_left = [-1.e5,-100,-100]
#mesh_yz.upper_right = [1.e5,100,100]
...
therm_abs_rate.filters = [openmc.EnergyFilter([0., 0.625]),openmc.UniverseFilter([fuel])] #Water cell
...
timesteps = [30.0*days, 30.0*days, 30.0*days, 30.0*days, 30.0*days,
