...
core_surf_tank_inner = openmc.ZCylinder(r=75.0,surface_id=5) #Inner surface reactor tank
...
fuel_cell_22 = openmc.Cell(cell_id=22, fill=clad, region= + fuel_surf & - fuel_surf_gap)
fuel_cell_23 = openmc.Cell(cell_id=23, fill=heavy_water, region= + fuel_surf_gap)
...
fuel_cell_24 = openmc.Cell(cell_id=24, fill=borated_water, region=-fuel_surf_clad_ir)
fuel_cell_25 = openmc.Cell(cell_id=25, fill=clad, region=+fuel_surf_clad_ir & -fuel_surf_clad_or)
fuel_cell_26 = openmc.Cell(cell_id=26, fill=borated_water, region=+fuel_surf_clad_or)
...
fuel_cell_70 = openmc.Cell(cell_id=70,fill=hot_water,region= +core_surf_lowertank_wall_in & -core_surf_uppertank_wall_in)
